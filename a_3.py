"""
A3: shared-encoder counterpart to D3 for the 3-cohort experiment.

Training mechanics match D3; the intended architectural difference is
one shared encoder instead of one encoder per cohort.
"""
...
train_harmonization_multi = train_harmonization
