...
def train_harmonization(
    ...
    for epoch in range(n_epochs):
        ...
        for batch_aug, batch_pr in train_iter:
            ...
            mmd = compute_mmd(x_hat_aug.flatten(start_dim=1), x_hat_pr.flatten(start_dim=1))
        ...
        if epoch % 10 == 0 or epoch == n_epochs - 1:
            print(f"epoch {epoch:3d}  train_loss {train_loss:.5f}  (recon {train_recon:.5f}  mmd {train_mmd:.6f})  "
