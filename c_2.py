"""Approach C2 core implementation.

Two independent cohort-specific autoencoders are trained separately.
Every patient is then encoded by both encoders and the two latent vectors
are concatenated for downstream classification.

This module contains the model/training utilities. Use c_2_sweep.py for
